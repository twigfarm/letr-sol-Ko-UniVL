...
class Youcook_Caption_DataLoader(Dataset):
    ...
    def _get_text(self, video_id, sub_id):
        ...
        for i in range(k):
            ...
            # For generate captions
            input_caption_ids = [self.tokenizer.convert_tokens_to_ids(word) for word in input_caption_words] 
            # output_caption_ids = self.tokenizer.convert_tokens_to_ids(output_caption_words)
            output_caption_ids = [self.tokenizer.convert_tokens_to_ids(word) for word in output_caption_words]
