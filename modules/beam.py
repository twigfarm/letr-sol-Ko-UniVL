...
class Constants():
    ...
    def from_tokenizer(cls, tokenizer):
        instance = cls()
        instance.PAD = tokenizer.token2idx[instance.PAD_WORD]
        instance.UNK = tokenizer.token2idx[instance.UNK_WORD]
        instance.BOS = tokenizer.token2idx[instance.BOS_WORD]
        instance.EOS = tokenizer.token2idx[instance.EOS_WORD]
        return instance
